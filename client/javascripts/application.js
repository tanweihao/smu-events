  ...
  $(function() {
    ...
    if ($("body").hasClass("login")) {
      Notifications.push({
        ...
        text: "<p>Welcome to Livelabs Events</p><div>Management system to create/edit events or check students' attendance!</div> <div>Please enter your email & password to log in.</div>",
        autoDismiss: 10
      });
    } else {
      new Notifications({
